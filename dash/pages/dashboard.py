...
layout = html.Div(className="cols_wrapper", children=[
        ...
        dash_treeview_antd.TreeView(
            ...
            data={
                ...
                'children': [{
                    ...
                    'key': 'biotech/floor_1',
                    'children': [
                        {'title': 'Lab 1', 'key': 'biotech/floor_1/lab_1'},
                        {'title': 'Lab 2', 'key': 'biotech/floor_1/lab_2'},
                        {'title': 'Lab 3', 'key': 'biotech/floor_1/lab_3'},
                    ],
                }]}
        )
    ]),
